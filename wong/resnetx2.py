...
__all__ = ['FoldBlock2', 'FoldBlock', 'TransitionBlock', 'ExpandBlock', 'ResNetX2', 'ResNetXTransition', 'num_units',
           'cal_num_params']
...
def num_units(folds, nodes):
    "calculate the number of all units in the backbone of ResNetX2."
...
def cal_num_params(Stem, Unit, folds, nodes, ni, bottle_scale, tail_all, c_out):
    "calcuate the number of all params of ResNetX2, according to hyper-params."
    m0 = Stem(3, no=ni)
